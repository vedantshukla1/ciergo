...
import { EXACT_OWNERS, BOOKINGS_ROWS } from '@/data/bookingTableMockData';
...
export const ActiveBookingsTable = ({ isSelectMode, selectAllTrigger, clearSelectionTrigger, searchQuery }: BookingTableProps) => {
  ...
  let currentRows = [...(BOOKINGS_ROWS as unknown as any[])];
